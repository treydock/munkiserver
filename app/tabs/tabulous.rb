...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #------------------------------------------------------------------------------------------------------------------------------#
      [    :admin_tab        ,    'Admin'              ,    ''        ,    false        ,    false        ],
      [    :admin_settings_tab        ,    'Settings'              ,    admin_settings_path        ,    true        ,    true        ],
      [    :package_categories_tab    ,    'Package Categories'    ,    package_categories_path    ,    true        ,    true        ],
      [    :permissions_tab           ,    'Permissions'           ,    permissions_path           ,    true        ,    true        ],
      #------------------------------------------------------------------------------------------------------------------------------#
      #    TAB NAME                   |    DISPLAY TEXT            |    PATH                       |    VISIBLE?    |    ENABLED?    #
      #------------------------------------------------------------------------------------------------------------------------------#
    ]
  ...
  config.actions do
    [
      ...
      #--------------------------------------------------------------------------------#
      [    :admin        ,    :index          ,    :admin_tab        ],
      [    :admin_settings        ,    :index          ,    :admin_settings_tab        ],
      [    :package_categories    ,    :all_actions    ,    :package_categories_tab    ],
      [    :permissions           ,    :all_actions    ,    :permissions_tab           ],
      #--------------------------------------------------------------------------------#
      #    CONTROLLER             |    ACTION          |    TAB                        #
      #--------------------------------------------------------------------------------#
    ]
