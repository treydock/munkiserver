#####################
# Custom TabsBuilder to keep current tab a link
# Only modified tab_for
######################
class MenuTabsBuilder < TabsOnRails::Tabs::Builder
      ...
      #   # => "<li class="current"><a href="/link/to/foo">Foo</a></li>"
      #
